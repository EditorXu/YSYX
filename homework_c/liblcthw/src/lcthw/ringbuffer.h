...
int RingBuffer_empty(RingBuffer *ringbuffer);

int RingBuffer_full(RingBuffer *ringbuffer);

int RingBuffer_available_data(RingBuffer *ringbuffer);

int RingBuffer_available_space(RingBuffer *ringbuffer);
